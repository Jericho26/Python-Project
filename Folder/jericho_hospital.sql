...
--
-- Host: localhost    Database: jericho
-- ------------------------------------------------------
...
CREATE TABLE `hospital` (
  ...
  `numberoftablet` varchar(45) DEFAULT NULL,
  ...
  `storageadvice` varchar(45) DEFAULT NULL,
...
INSERT INTO `hospital` VALUES ('biogesic',12344,'500mg','10','22212','2222023','2222026','50mg','vomit, headache','cant sleep at night','80/120','n/a','biogesic only','12','34332','kim','12222000','Cuta, Batangas City'),('biogesic',123446,'500mg','10','22212','2222023','2222026','50mg','vomit, headache','cant sleep at night','80/120','n/a','biogesic only','12','34332','kim','12222000','Cuta, Batangas City');
...
-- Dump completed on 2023-12-16 10:16:41
